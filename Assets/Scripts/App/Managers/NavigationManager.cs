...
namespace GrandDevs.AppName
{
    public class NavigationManager : IService, INavigationManager
    {
        ...
        public void Dispose()
        {
            _inputManager.UnregisterKeyboardInputHandler(_registeredTabHandlerIndex);
        }
        ...
        public void Init()
        {
            ...
            _registeredTabHandlerIndex = _inputManager.RegisterKeyboardInputHandler(KeyCode.Tab, null, OnInputDownTabButton, null);
        }
